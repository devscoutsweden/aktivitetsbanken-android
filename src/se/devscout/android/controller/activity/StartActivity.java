    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuStartClearImageCache:
                CleanImageCacheTaskExecutor executor = new CleanImageCacheTaskExecutor() {
                    @Override
                ...
                executor.run(null, this);
                Toast.makeText(this, R.string.clearImageCacheDone, Toast.LENGTH_SHORT);
                break;

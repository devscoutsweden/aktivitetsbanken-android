...
public class ReferenceCursor extends BaseCursorWrapper {
    public ReferenceCursor(SQLiteDatabase db) {
        super(db.query(
                ...
                new String[]{Database.reference.id, Database.reference.server_id, Database.reference.server_revision_id, Database.reference.description, Database.reference.uri},
                null,
                null,
                null,
                null,
    ...
    public ReferenceBean getReference() throws URISyntaxException {
        return new ReferenceBean(
                ...
                new URI(getString(getColumnIndex(Database.reference.uri))), null);

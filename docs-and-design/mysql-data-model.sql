...
CREATE TABLE IF NOT EXISTS `mydb`.`activity` (
  ...
  `likes` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_activity_user1_idx` (`owner_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`activity_data` (
  ...
  INDEX `fk_activity_data_activity_idx` (`activity_id` ASC),
  PRIMARY KEY (`id`),
  INDEX `fk_activity_data_user1_idx` (`author_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`comment` (
  ...
  INDEX `fk_comment_user1_idx` (`owner_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`category` (
  ...
  `status` CHAR(1) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_category_user1_idx` (`owner_id` ASC),
  UNIQUE INDEX `uuid_UNIQUE` (`uuid` ASC),
  UNIQUE INDEX `idx_group_name` (`group_name` ASC, `name` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`comment_data` (
  ...
  `source_uri` VARCHAR(200) NULL,
  INDEX `fk_comment_data_comment1_idx` (`id` ASC),
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`reference` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `idx_uri_type` (`uri` ASC, `type` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`favourite_activity` (
  ...
  INDEX `fk_activity_has_user_user1_idx` (`user_id` ASC),
  INDEX `fk_activity_has_user_activity1_idx` (`activity_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`comment_data_media` (
  ...
  INDEX `fk_comment_data_has_media_media1_idx` (`media_id` ASC),
  INDEX `fk_comment_data_has_media_comment_data1_idx` (`comment_data_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`activity_data_media` (
  ...
  INDEX `fk_activity_data_has_media_media1_idx` (`media_id` ASC),
  INDEX `fk_activity_data_has_media_activity_data1_idx` (`activity_data_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`activity_data_reference` (
  ...
  INDEX `fk_activity_data_has_reference_reference1_idx` (`reference_id` ASC),
  INDEX `fk_activity_data_has_reference_activity_data1_idx` (`activity_data_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`activity_data_category` (
  ...
  INDEX `fk_activity_data_has_category_category1_idx` (`category_id` ASC),
  INDEX `fk_activity_data_has_category_activity_data1_idx` (`activity_data_id` ASC),

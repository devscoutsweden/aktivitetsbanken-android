...
CREATE INDEX `fk_category_media1_idx` ON `mydb`.`category` (`icon_media_id` ASC);

CREATE INDEX `idx_icon_media_id` ON `mydb`.`category` (`icon_media_id` ASC);

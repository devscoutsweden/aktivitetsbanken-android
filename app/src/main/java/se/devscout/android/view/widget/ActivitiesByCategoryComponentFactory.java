...
public class ActivitiesByCategoryComponentFactory extends AbstractComponentFactory implements WidgetComponentFactory, TabComponentFactory {
    public ActivitiesByCategoryComponentFactory(String name) {
